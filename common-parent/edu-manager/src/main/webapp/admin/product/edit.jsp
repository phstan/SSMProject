...
<!-- 使用jQuery完成操作
	1 , 当页面加载完成时 , 完成两个下拉选的选择
	2 , 使用属性选择器 ,将商品是否热门\商品所属类别设置位已选状态 -->

<script type="text/javascript">
	//当页面加载完成事件
	$(function() {
		/* alert("jQuery success") */
		$("select[name='is_hot'] option[value='${product.is_hot}']").prop("selected" , true)
		
		$("select[name='cid'] option[value='${product.cid }']").prop("selected" , true)
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/AdminProductEditServlet" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<img src="${pageContext.request.contextPath}/${product.pimage }" width="100px" height="100px" alt="no image" />
