...
$(function() {
	$("#cartButton").click(function(){
		...
		location.href ="/shop/addCart.do?pid=${product.pid }&num="+num ;
	})
})
	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="/shop/index.do">首页</a>&nbsp;&nbsp;&gt; &nbsp;&nbsp;<a href="/page/product.do?cid=${category.cid }">${category.cname }</a>
				&nbsp;&nbsp;&gt;&nbsp;&nbsp;${product.pname }
				<a></a>
			</div>
				...
				<div class="col-md-6">
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<input  id="cartButton" style="background: url('./images/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0); height: 36px; width: 127px;"
